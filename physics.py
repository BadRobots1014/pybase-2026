...
def create_apriltag_manager(field: Field2d) -> AprilTagManager:
    ...
    # This list is for 2026 rebuilt, welded field
    tag_data = [
        (1, 467.64, 292.31, 35.00, 180, 0),
        (2, 469.11, 182.60, 44.25, 90, 0),
        (3, 445.35, 172.84, 44.25, 180, 0),
        (4, 445.35, 158.84, 44.25, 180, 0),
        (5, 469.11, 135.09, 44.25, 270, 0),
        (6, 467.64, 25.37, 35.00, 180, 0),
        (7, 470.59, 25.37, 35.00, 0, 0),
        (8, 483.11, 135.09, 44.25, 270, 0),
        (9, 158.34, 144.84, 44.25, 0, 0),
        (10, 492.88, 158.84, 44.25, 0, 0),
        (11, 483.11, 182.60, 44.25, 90, 0),
        (12, 470.59, 292.31, 35.00, 0, 0),
        (13, 650.92, 291.47, 21.75, 180, 0),
        (14, 650.92, 274.47, 21.75, 180, 0),
        (15, 650.90, 170.22, 21.75, 180, 0),
        (16, 650.90, 153.22, 21.75, 180, 0),
        (17, 183.59, 25.37, 35.00, 0, 0),
        (18, 182.11, 135.09, 44.25, 270, 0),
        (19, 205.87, 144.84, 44.25, 0, 0),
        (20, 205.87, 158.84, 44.25, 0, 0),
        (21, 182.11, 182.60, 44.25, 90, 0),
        (22, 183.59, 292.31, 35.00, 0, 0),
        (23, 180.64, 292.31, 35.00, 180, 0),
        (24, 168.11, 182.60, 44.25, 90, 0),
        (25, 158.34, 172.84, 44.25, 180, 0),
        (26, 158.34, 158.84, 44.25, 180, 0),
        (27, 168.11, 135.09, 44.25, 270, 0),
        (28, 180.64, 25.37, 35.00, 180, 0),
        (29, 0.30, 26.22, 21.75, 0, 0),
        (30, 0.30, 43.22, 21.75, 0, 0),
        (31, 0.32, 147.47, 21.75, 0, 0),
        (32, 0.32, 164.47, 21.75, 0, 0),
    ]
